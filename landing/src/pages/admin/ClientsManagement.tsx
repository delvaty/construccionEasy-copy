...
export default function ClientsManagement() {
  ...
  const [ongoingClient, setOngoingClient] =
    useState<OngoingResidenceProcess | null>(null);
  const [newClient, setNewClient] = useState<NewResidenceApplication | null>(
    null
  );
  ...
  const handleOngoingProcessChange = (
    e: React.ChangeEvent<
      HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement
    >
  ) => {
  ...
  const handleSubmitEdit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      displayAlert(
        "Error al actualizar el cliente. Inténtelo de nuevo.",
        "error"
      );
    }
  };
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6">
      ...
      {showAlert && (
        <div
          className={`fixed top-5 right-5 z-50 p-4 rounded-lg shadow-lg flex items-center space-x-3 ${
            alertType === "success"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {selectedClient.current_job || "No especificado"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Agencia:</span>
                    <span className="font-medium">
                      {selectedClient.current_agency || "No especificado"}
                    </span>
                  </div>
                </div>
              </div>
              ...
              {ongoingClient && (
                <div className="bg-gray-50 p-5 rounded-lg md:col-span-2">
                  <h3 className="text-lg font-semibold mb-4 text-gray-800">
                    Información del Proceso de Residencia
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {ongoingClient.first_name}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">Apellido:</span>
                        <span className="font-medium">
                          {ongoingClient.last_name}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {ongoingClient.has_work_permit ? "Sí" : "No"}
                        </span>
                      </div>
                    </div>
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {ongoingClient.process_stage}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">Número de caso:</span>
                        <span className="font-medium">
                          {ongoingClient.case_number || "No especificado"}
                        </span>
                      </div>
                    </div>
                    <div className="space-y-3">
                    ...
                    <div className="md:col-span-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {ongoingClient.completed_steps} de{" "}
                          {ongoingClient.total_steps} pasos completados
                        </span>
                      </div>
                      <div className="mt-2 w-full bg-gray-200 rounded-full h-2.5">
                        <div
                          ...
                          style={{
                            width: `${Math.round(
                              (ongoingClient.completed_steps /
                                ongoingClient.total_steps) *
                                100
                            )}%`,
                          }}
                        ></div>
              ...
              {newClient && (
                <div className="bg-gray-50 p-5 rounded-lg md:col-span-2">
                  <h3 className="text-lg font-semibold mb-4 text-gray-800">
                    Información de la Nueva Aplicación de Residencia
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {newClient.place_of_birth}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">Número PESEL:</span>
                        <span className="font-medium">
                          {newClient.pesel_number}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">Altura:</span>
                        <span className="font-medium">
                          {newClient.height_cm} cm
                        </span>
                      </div>
                    </div>
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {newClient.hair_color}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">Tatuajes:</span>
                        <span className="font-medium">
                          {newClient.has_tattoos ? "Sí" : "No"}
                        </span>
                      </div>
                    </div>
                    <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {newClient.marital_status}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">Nivel educativo:</span>
                        <span className="font-medium">
                          {newClient.education_level}
                        </span>
                      </div>
                    </div>
                    <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {newClient.traveled_last_5_years ? "Sí" : "No"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-500">
                        ...
                        <span className="font-medium">
                          {newClient.has_relatives_in_poland ? "Sí" : "No"}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        type="text"
                        name="place_of_birth"
                        value={newClient.place_of_birth}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        type="text"
                        name="marital_status"
                        value={newClient.marital_status}
                        onChange={handleNewClientChange}
                        className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm py-2 px-3 border"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        value={newClient.education_level}
                        onChange={handleNewClientChange}
                        className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm py-2 px-3 border"
                      />
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        <option value="">Seleccionar...</option>
                        <option value="Preparación de documentos">
                          Preparación de documentos
                        </option>
                        <option value="Presentación de solicitud">
                          Presentación de solicitud
                        </option>
                        <option value="En revisión">En revisión</option>
                        <option value="Entrevista programada">
                          Entrevista programada
                        </option>
                        <option value="Documentos adicionales requeridos">
                          Documentos adicionales requeridos
                        </option>
                        <option value="Decisión pendiente">
                          Decisión pendiente
                        </option>
