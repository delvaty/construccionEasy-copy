...
const LoginPage = () => {
  ...
  const [loginSuccessuful, setLoginSuccessuful]= useState(false);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(false);
    setLoginSuccessuful(true);
        
    } catch(err: any){
        setIsLoading(false);
        setError(err.message || "Error al iniciar sesisón");
  ...
  return (
    <div className="fixed inset-0 min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center px-4">
